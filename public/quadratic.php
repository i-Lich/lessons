...
<body>
    ...
    <h1 style="text-align: center">Квадратные уровнения</h1>
    ...
    <form action="index.php" method="post" title="asd">
        Введите уравнение:
        <p>
            <input title="Коэффициент 1" type="text" name="coefficient1" class="oms"><span class="oms_formula">x</span><sup class="sap">2</sup> +
            <input title="Коэффициент 2" type="text" name="coefficient2" class="oms"><span class="oms_formula">x</span> +
            <input title="Коэффициент 3" type="text" name="coefficient3" class="oms"> = 0
        </p>
    ...
    <?php
        ...
        if (isset($_POST['coefficient1'])) {
            $coefficient1 = (int)$_POST['coefficient1'];
        } else $coefficient1 = '';
        if (isset($_POST['coefficient2'])) {
            $coefficient2 = (int)$_POST['coefficient2'];
        }   $coefficient2 = '';
        if (isset($_POST['coefficient3'])) {
            $coefficient3 = (int)$_POST['coefficient3'];
        }   $coefficient3 = '';
        if($coefficient1 == '0'){
